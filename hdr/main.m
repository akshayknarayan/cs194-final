...
%     figure, imshow(durand_result);
    ...
    % Sample 2: Garage (Source)
    directory = 'garage';
    [linear_result, global_result, durand_result] = create_hdr_image(50, 0.09, 6, 0.5, directory, 'jpg');
...
%     figure, imshow(durand_result);
    ...
    % Sample 4: Aviemore 2 (Mine)
    directory = 'aviemore2';
    [linear_result, global_result, durand_result] = create_hdr_image(50, 0.54, 6, 0.7, directory, 'jpg');
